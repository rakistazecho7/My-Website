...
$(document).ready(function () {
  ...
  })(jQuery); // input text for typing animation


  $("#holder").writeText("WEB DESIGNER + FRONT-END DEVELOPER"); // initialize wow.js

  new WOW().init(); // Push the body and the nav over by 285px over
  ...
  $(document).ready(main); // initiate full page scroll
  ...
  $("#fullpage").fullpage({
    ...
    afterLoad: function afterLoad(anchorLink, index) {
      var loadedSection = $(this); //using index
